...
let strategyPlan  = require('../models/elements/plan');
...
module.exports.renderComponentsForm = (req, res) => {
...
module.exports.showPlan = (req, res) => {
...
module.exports.renderEditForm = null

module.exports.updatePlan = null
